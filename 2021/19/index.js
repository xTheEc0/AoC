...
console.log(`Part 1: ${Part1(file)}`); // 439
console.log(`Part 2: ${Part2(file)}`); // 11985
...
console.log(`\n\n ~ TESTS ~ `);
// Part 1 tests
assert.strictEqual(Part1(testData), 79);

// Part 2 tests
assert.strictEqual(Part2(testData), 3621);
