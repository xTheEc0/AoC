...
assert.strictEqual(Part1(['((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2']), 13632);
...
assert.strictEqual(Part2(['5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))']), 669060);
assert.strictEqual(Part2(['((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2']), 23340);
